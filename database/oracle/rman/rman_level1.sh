...
backup incremental level 1 database format '/u01/backup/rman1/db_%U.bak'
plus archivelog format '/u01/backup/rman1/ar_%U.bak';
backup current controlfile format '/u01/backup/rman1/ctl_%U.bak';
