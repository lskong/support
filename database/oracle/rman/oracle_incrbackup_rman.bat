...
echo BACKUP INCREMENTAL LEVEL %RMAN_LEVEL% CUMULATIVE DATABASE FORMAT "level_%RMAN_LEVEL%_%%d_%%s_%%p_%%u_%%T.dbf"; >> %CMDFILE%
...
:USAGE
echo Usage:  oracle_incrbackup.bat oracle_sid backup_type  samba_dir password
goto END
