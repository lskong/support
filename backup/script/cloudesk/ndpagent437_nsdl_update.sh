...
G_CRON_PATH="/var/spool/cron/root"
G_MESSAGE=""
...
edit(){
	...
	sed -i '/ndpagent/d' $G_CRON_PATH
	echo "* */2 * * * {$G_NDP_NSDL_PATH}/{$G_NDP_NSDL_VER}/ndpagent_check_cron.sh" >> $G_CRON_PATH
